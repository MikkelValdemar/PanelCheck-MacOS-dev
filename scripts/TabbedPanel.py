...
class TabPanel(wx.Panel):
    def __init__(
        ...
        self.tree = wx.TreeCtrl(id=wx.NewId(), name=u'tree', parent=self, size=wx.Size(
            250, 400), style=wx.TR_HAS_BUTTONS | wx.TR_DEFAULT_STYLE | wx.SUNKEN_BORDER)

        self.tree.Bind(wx.EVT_LEFT_DCLICK, self.on_tree_left_double_click)

        self.text_Ass = wx.StaticText(
            id=wx.NewId(),
            label=u'Assessors:',
            name=u'text_Ass',
            parent=self,
            style=0)
        self.text_Att = wx.StaticText(
            id=wx.NewId(),
            label=u'Attributes:',
            name=u'text_Att',
            parent=self,
            style=0)
        self.text_Samp = wx.StaticText(
            id=wx.NewId(),
            label=u'Samples:',
            name=u'text_Samp',
            parent=self,
        ...
        self.checkList_Ass = wx.CheckListBox(
            choices=[],
            id=c_ass_id,
            name=u'checkList_Ass',
            parent=self,
            style=0)
        ...
        self.checkList_Att = wx.CheckListBox(
            choices=[],
            id=c_att_id,
            name=u'checkList_Att',
            parent=self,
            style=0)
        ...
        self.checkList_Samp = wx.CheckListBox(
            choices=[],
            id=c_samp_id,
            name=u'checkList_Samp',
            parent=self,
            style=0)
        ...
        self.button_Ass_EnableAll = wx.Button(
            id=butt_ass_en_id,
            label=u'Enable all',
            name=u'button_Ass_EnableAll',
            parent=self,
            style=0)
        ...
        self.button_Ass_DisableAll = wx.Button(
            id=butt_ass_di_id,
            label=u'Disable all',
            name=u'button_Ass_DisableAll',
            parent=self,
            style=0)
        ...
        self.button_Att_EnableAll = wx.Button(
            id=butt_att_en_id,
            label=u'Enable all',
            name=u'button_Att_EnableAll',
            parent=self,
            style=0)
        ...
        self.button_Att_DisableAll = wx.Button(
            id=butt_att_di_id,
            label=u'Disable all',
            name=u'button_Att_DisableAll',
            parent=self,
            style=0)
        ...
        self.button_Samp_EnableAll = wx.Button(
            id=butt_samp_en_id,
            label=u'Enable all',
            name=u'button_Samp_EnableAll',
            parent=self,
            style=0)
        ...
        self.button_Samp_DisableAll = wx.Button(
            id=butt_samp_di_id,
            label=u'Disable all',
            name=u'button_Samp_DisableAll',
            parent=self,
            style=0)
        ...
        ass_butt_box.Add(self.button_Ass_EnableAll, 0,
                         wx.FIXED_MINSIZE | wx.ALIGN_CENTER)
        ass_butt_box.AddSpacer(4)
        ass_butt_box.Add(self.button_Ass_DisableAll, 0,
                         wx.FIXED_MINSIZE | wx.ALIGN_CENTER)
        ...
        att_butt_box.Add(self.button_Att_EnableAll, 0,
                         wx.FIXED_MINSIZE | wx.ALIGN_CENTER)
        att_butt_box.AddSpacer(4)
        att_butt_box.Add(self.button_Att_DisableAll, 0,
                         wx.FIXED_MINSIZE | wx.ALIGN_CENTER)
        ...
        samp_butt_box.Add(self.button_Samp_EnableAll, 0,
                          wx.FIXED_MINSIZE | wx.ALIGN_CENTER)
        samp_butt_box.AddSpacer(4)
        samp_butt_box.Add(self.button_Samp_DisableAll, 0,
                          wx.FIXED_MINSIZE | wx.ALIGN_CENTER)
