...
from Plot_Tools import assign_colors, str_row, num2str, set_xlabeling, set_xlabeling_rotation, OverviewPlotter, equal_lists, raw_data_grid, axes_create, axes_setup, numerical_data_add_scores, OverviewPlotter, significance_legend, colored_frame
...
def profilePlotter(s_data, plot_data, num_subplot=[1, 1, 1],abspath=None, **kwargs):
    ...
    if plot_data.view_legend:
        ...
        #fig.legend(plotList, _legend_texts, loc='upper right')
