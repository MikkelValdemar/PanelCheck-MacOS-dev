...
from Plot_Tools import raw_data_grid, axes_create, axes_setup, numerical_data_grid, colors_hex_list, assign_colors, significance_legend, OverviewPlotter, colored_frame
...
def pmsePlotter(s_data, plot_data, num_subplot=[1, 1, 1],abspath=None, **kwargs):
    ...
    if itemID[0] not in collectedActiveItemsList:
        ...
        ax.scatter(x_values, y_values, s=15, c='gray', marker='o')
                ...
                if len(activeAttributesList) <= colored_lim and len(
                    ...
                    for attribute in activeAttributesList:
                        ...
                        if c_index >= len(activeAssessorsList):
                            c_index = 0
                    fig.legend(plotList, activeAttributesList, loc='upper right')
